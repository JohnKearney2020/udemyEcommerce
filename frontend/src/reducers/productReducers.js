...
import { PRODUCT_CREATE_REQUEST, PRODUCT_CREATE_SUCCESS, PRODUCT_CREATE_FAIL, PRODUCT_CREATE_RESET } from '../constants/productConstants.js';
import { PRODUCT_UPDATE_REQUEST, PRODUCT_UPDATE_SUCCESS, PRODUCT_UPDATE_FAIL, PRODUCT_UPDATE_RESET } from '../constants/productConstants.js';
import { 
...
//Reducers contain the actual actions that get dispatched here
...
export const productTopRatedReducer = (state = { products: [] }, action) => {
  ...
  switch (action.type) {
    case PRODUCT_TOP_REQUEST:
      // Note, see how this differs if we did not pass in the empty array here
        return { loading: true, products: [] }
